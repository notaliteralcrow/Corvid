...
Early release: Corvid is freshly released and while it has been tested, bugs may surface during normal play. If you encounter an issue please report it on the GitHub issues page with a description of what you were doing and any error messages shown.
...
Copy the corvid_installer/ contents to your Nest (e.g. /root/corvidinstaller/)
Run installer0.src through installer7.src in order — open each in Code Editor, Save, Build, Run
Copy the tools/ folder to /Corvid/tools/ via FileExplorer
Launch Corvid and build the tool binaries:
...
Author: PurpleBird
Chainsaw — the integrated password cracker is ChainSaw by NitroCynic, a Markov chain password cracker released under the MIT licence and ported to GreyScript for use in Corvid.
